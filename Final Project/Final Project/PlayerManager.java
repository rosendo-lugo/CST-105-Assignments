...
public class PlayerManager {
    ...
    ArrayList<NFLPlayer> availableLIST_OF_PLAYERS = new ArrayList<>();

    ArrayList<String> playerNames = new ArrayList<>();

    public void createLIST_OF_PLAYERS(int howMany) {
	...
	static ArrayList<NFLPlayer> LIST_OF_PLAYERS = new ArrayList<NFLPlayer>();
